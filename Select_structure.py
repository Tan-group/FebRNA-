...
def Select_structure(ffile):
    ...
    allnum = len(glob.glob("%s/FINAL_Result/*.pdb"%(ffile)))
    # os.system("ulimit -s unlimited")
    route = fr'ulimit -s unlimited; ./cgRNASP-Feb %s/FINAL_Result/ {allnum} %s_Energy_out.csv'%(ffile, ffile)
